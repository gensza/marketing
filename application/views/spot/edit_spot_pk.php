                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <form action="<?= base_url('Spot/updateSpot') ?>" method="POST">
                                            ...
                                            <h4 class="header-title mb-2">Edit Form Spot PK</h4>
                                            <div class="row">
                                                ...
                                                <div class="border col-lg-12 col-12 p-3 mb-2 rounded">
                                                    ...
                                                    <div class="row mt-1">
                                                        <div class="form-group mb-1 col-6">
                                                            ...
                                                            <input type="number" class="form-control" id="quantity" name="quantity" placeholder="Kuantitas" value="<?= $spot['quantity'] ?>" required>
                                                        </div>
                                                        <div class="form-group mb-1 col-6">
                                                    ...
                                                    <div class="row mt-1">
                                                        <div class="form-group mb-1 col-6">
                                                            ...
                                                            <input type="number" class="form-control" id="unit_price" name="unit_price" placeholder="Harga satuan" value="<?= $spot['unit_price'] ?>">
                                                        </div>
                                                        <div class="custom-control custom-checkbox mt-4 ml-2">
                                                            <input type="checkbox" name="ppn" class="custom-control-input" id="customCheck1" <?php if ($spot['ppn'] == 'on') {
                                                                                                                                                    echo 'checked';
                                                                                                                                                } ?>>
                                                ...
                                                <div class="border col-lg-12 col-12 p-3 mb-3 rounded">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="row col-6 mt-2 ml-3">
                                                            ...
                                                            <div class="col-7">
                                                                <div class="form-group ml-1">
                                                                    <input type="text" name="k_dirt_level" id="card-number" class="form-control" value="<?= $spot['k_dirt_level'] ?>">
                                                                </div>
                                                            </div>
                                                            <div class="col-0">
                                                                <div class="form-group">
                                                    ...
                                                    <div class="row mt-2">
                                                        ...
                                                        <div class="col-5">
                                                            <div class="form-group">
                                                                <input type="text" name="k_water_level" id="card-number" class="form-control" value="<?= $spot['k_water_level'] ?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-0">
                                                            <div class="form-group">
