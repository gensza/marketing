                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item">Data SPOT</li>
                                <li class="breadcrumb-item active">View Invoice SPOT</li>
                            </ol>
                        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card-box">
                        ...
                        <form action="<?= base_url('Invoice/viewPrintSpot') ?>" method="POST">
                            <input type="hidden" name="invoice_number" value="<?= $invoice_no ?>">
                            <input type="hidden" name="contract_number" value="<?= $contract['spot_number'] ?>">
                            <input type="hidden" name="contract_type" value="spot">
                            <input type="hidden" name="id_contract_type" value="<?= $contract['id_spot'] ?>">
                                    ...
                                    <div class="mt-3 float-right">
                                        <p class="m-b-10"><strong>Invoice Date : </strong> <span
                                                class="float-right"><input type="text" name="invoice_date"
                                                    ...
                                                    value="<?= $contract['spot_date'] ?>"></span></p>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><input type="number" id="qty" name="qty" style="width:100px;"
                                                            value="<?= $contract['quantity'] ?>" required></td>
