                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item">View Invoice SPOT</li>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card-box">
                        ...
                        <form action="<?= base_url('Invoice/saveInvoiceSpot') ?>" method="POST">
                            ...
                            <div class="mt-2 mb-1">
                                <div class="text-right d-print-none">
                                    <a href="<?= base_url('Invoice/viewInvoiceSpot/' . $print['id_contract_type']) ?>"
