                                                    ...
                                                    <div class="row mt-2">
                                                        ...
                                                        <div class="col-10">
                                                            <textarea class="form-control" name="mip_notes"
                                                                id="example-textarea" rows="3"
                                                                placeholder="Write some note.."><?= $stc['mip_notes'] ?></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="row mt-1">
                                                        <div class="col-2">
                                                        ...
                                                        <div class="col-10">
                                                            <textarea class="form-control" name="mip_lainya"
                                                                id="example-textarea" rows="3"
                                                                placeholder="Write some note.."><?= $stc['mip_lainya'] ?></textarea>
                                                        </div>
                                                    </div>
