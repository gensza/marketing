                                                ...
                                                <div class="border col-lg-6 col-12 p-3 mb-3 rounded">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="row col-6 mt-2 ml-3">
                                                            ...
                                                            <div class="col-7">
                                                                <div class="form-group ml-1">
                                                                    <input type="text" name="s_dirt_level" id="card-number" class="form-control" value="<?= $ltc['k_dirt_level'] ?>">
                                                                </div>
                                                            </div>
                                                            <div class="col-0">
                                                                <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-10">
                                                            <textarea class="form-control" name="s_notes" id="example-textarea" rows="3" placeholder="Write some note.."><?= $ltc['k_notes'] ?></textarea>
                                                        </div>
                                                    </div>
