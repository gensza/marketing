                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <form action="<?= base_url('Stc/saveStc') ?>" method="POST">
                                            ...
                                            <h4 class="header-title mb-2">Form STC CGK</h4>
                                            <div class="row">
                                                ...
                                                <div class="border col-lg-6 col-12 p-3 mb-3 rounded">
                                                    ...
                                                    <div class="row">
                                                        <div class="row col-6 mt-2">
                                                            ...
                                                            <div class="col-7">
                                                                <div class="form-group ml-1">
                                                                    <input type="number" name="s_ffa_max" id="card-number" class="form-control" value="<?= $ltc['k_ffa_max'] ?>">
                                                                </div>
                                                            </div>
                                                            <div class="col-0">
                                                                <div class="form-group">
                                                        ...
                                                        <div class="row col-6 mt-2 ml-2">
                                                            ...
                                                            <div class="col-7">
                                                                <div class="form-group ml-1">
                                                                    <input type="number" name="s_dirt_level" id="card-number" class="form-control" value="<?= $ltc['k_dirt_level'] ?>">
                                                                </div>
                                                            </div>
                                                            <div class="col-0">
                                                                <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        <div class="row col-6 mt-2">
                                                            ...
                                                            <div class="col-7">
                                                                <div class="form-group ml-1">
                                                                    <input type="text" name="s_water_level" id="card-number" class="form-control" value="<?= $ltc['k_water_level'] ?>">
                                                                </div>
                                                            </div>
                                                            <div class="col-0">
                                                                <div class="form-group">
                                                        ...
                                                        <div class="row col-6 mt-2 ml-2">
                                                            ...
                                                            <div class="col-7">
                                                                <div class="form-group ml-1">
                                                                    <input type="text" name="s_rendemen" id="card-number" class="form-control" value="<?= $ltc['k_rendemen'] ?>">
                                                                </div>
                                                            </div>
                                                            <div class="col-0">
                                                                <div class="form-group">
                                                ...
                                                <div class="col-lg-6 col-12">
                                                    <div class="border p-3 mt-lg-0 rounded">
                                                        <h4 class="header-title mb-3">Detail LTC CGK</h4>
