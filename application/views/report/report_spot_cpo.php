            ...
            <tr style="height:24.7pt;">
                ...
                <tr style="height:24.7pt;">
                    ...
                    <td style="width:315.25pt; border-top:0.75pt solid #ffffff; border-left:0.75pt solid #ffffff; border-bottom:0.75pt solid #ffffff; padding-right:5.03pt; padding-left:5.03pt; vertical-align:top;">
                        <ul style="margin-top:0pt; padding-left:0pt;" type="disc">
                            ...
                            <p style="margin-top:0pt; margin-bottom:0pt; font-size:9pt;"><span style="font-family:Calibri;">- M & I MAX <?= $spot['k_mi_max'] ?> % </span></p>
                            <p style="margin-top:0pt; margin-bottom:0pt; font-size:9pt;"><span style="font-family:Calibri;">- DOBI MIN <?= $spot['k_dobi_min'] ?></span></p>
                ...
                <tr style="height:24.7pt;">
                    ...
                    <td style="width:315.25pt; border-top:0.75pt solid #ffffff; border-left:0.75pt solid #ffffff; border-bottom:0.75pt solid #ffffff; padding-right:5.03pt; padding-left:5.03pt; vertical-align:top;">
                        ...
                        <p style="margin-top:0pt; margin-bottom:0pt; font-size:10pt;"><span style="font-family:Calibri;">- FFA ≥ <?= $spot['pfp_ffa1'] ?> % - <?= $spot['pfp_min1'] ?> % ADALAH Rp. <?= $spot['pfp_rp1'] ?>,-/<?= $spot['unit'] ?> (<?php if($spot['pfp_ppn1'] == 'on'){echo "INCLUDE PPN 10%";}else{echo "EXCLUDE PPN 10%";} ?>)</span></p>

                        <p style="margin-top:0pt; margin-bottom:0pt; font-size:10pt;"><span style="font-family:Calibri;">- FFA ≥ <?= $spot['pfp_ffa2'] ?> % - <?= $spot['pfp_min2'] ?> % ADALAH Rp. <?= $spot['pfp_rp2'] ?>,-/<?= $spot['unit'] ?> (<?php if($spot['pfp_ppn2'] == 'on'){echo "INCLUDE PPN 10%";}else{echo "EXCLUDE PPN 10%";} ?>)</span></p>

                        <p style="margin-top:0pt; margin-bottom:0pt; font-size:10pt;"><span style="font-family:Calibri;">- FFA ≥ <?= $spot['pfp_ffa3'] ?> %, PEMBELI BERHAK MENOLAK / MENERIMA DENGAN NEGOSIASI ULANG</span></p>

                        <p style="margin-top:5pt; margin-bottom:0pt; font-size:10pt;"><span style="font-family:Calibri;">DOBI PINALTY</span></p>
                        <p style="margin-top:0pt; margin-bottom:0pt; font-size:10pt;"><span style="font-family:Calibri;">- MUTU DOBI ≥ <?= $spot['pdb_md1'] ?> - <?= $spot['pdb_min1'] ?>, DIKLAIM Rp. <?= $spot['pdb_rp1'] ?>,-/<?= $spot['unit'] ?> (<?php if($spot['pdb_ppn1'] == 'on'){echo "INCLUDE PPN 10%";}else{echo "EXCLUDE PPN 10%";} ?>)</span></p>

                        <p style="margin-top:0pt; margin-bottom:0pt; font-size:10pt;"><span style="font-family:Calibri;">- MUTU DOBI ≥ <?= $spot['pdb_md2'] ?> - <?= $spot['pdb_min2'] ?>, DIKLAIM Rp. <?= $spot['pdb_rp2'] ?>,-/<?= $spot['unit'] ?> (<?php if($spot['pdb_ppn2'] == 'on'){echo "INCLUDE PPN 10%";}else{echo "EXCLUDE PPN 10%";} ?>)</span></p>

                        <p style="margin-top:0pt; margin-bottom:0pt; font-size:10pt;"><span style="font-family:Calibri;">- MUTU DOBI ≥ <?= $spot['pdb_md3'] ?> - <?= $spot['pdb_min3'] ?>, DIKLAIM Rp. <?= $spot['pdb_rp3'] ?>,-/<?= $spot['unit'] ?> (<?php if($spot['pdb_ppn3'] == 'on'){echo "INCLUDE PPN 10%";}else{echo "EXCLUDE PPN 10%";} ?>)</span></p>
                        <p style="margin-top:5pt; margin-bottom:0pt; font-size:10pt;"><span style="font-family:Calibri;">M & I PINALTY</span></p>
                        <p style="margin-top:0pt; margin-bottom:0pt; font-size:9pt;"><span style="font-family:Calibri;"><?= $spot['mip_notes'] ?></span></p>
                    </td>
                </tr>
                <tr style="height:24.7pt;">
                    <td style="width:139.45pt; border-top:0.75pt solid #ffffff; border-right:0.75pt solid #ffffff; border-bottom:0.75pt solid #ffffff; padding-right:5.03pt; padding-left:5.03pt; vertical-align:top;">
                    ...
                    <td style="width:315.25pt; border-top:0.75pt solid #ffffff; border-left:0.75pt solid #ffffff; border-bottom:0.75pt solid #ffffff; padding-right:5.03pt; padding-left:5.03pt; vertical-align:top;">
                        <ul style="margin-top:10pt; padding-left:0pt;" type="disc">
                            <p style="margin-top:0pt; margin-bottom:0pt; font-size:9pt;"><span style="font-family:Calibri;"><?= $spot['mip_lainya'] ?></span></p>
                        </ul>
                        <br>
                    </td>
                </tr>
